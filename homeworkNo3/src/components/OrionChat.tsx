...
export function OrionChat({ wishes }: OrionChatProps) {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto h-[78vh] flex rounded-xl border border-white/10 bg-[#0E0E10] shadow-2xl overflow-hidden relative">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6 scrollbar-thin">
          {loadingHistory ? (
            <div className="flex flex-col items-center justify-center h-full space-y-3">
              ...
              <p className="text-xs text-zinc-500 font-mono">RETRIEVING MEMORY SCROLLS...</p>
            </div>
          ) : (
            <>
